...
SECRET_KEY = 'django-insecure-3-8eb_ex)q=gw=_aso-@g8=w1)hw=dt*#1#@hh1gi3zu()4j##'
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 5000 * 1024 * 1024  # 5 GB
DATA_UPLOAD_MAX_MEMORY_SIZE = 10000 * 1024 * 1024  # 1 GB

# Allowed file extensions
ALLOWED_IMAGE_EXTENSIONS = ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.tiff']
ALLOWED_MODEL_EXTENSIONS = ['.blend']
